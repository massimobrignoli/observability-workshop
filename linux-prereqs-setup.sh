...
#
# DOWNLOAD APM AGENT
wget -O /home/centos/spring-petclinic-master/elastic-apm-agent-1.9.0.jar https://search.maven.org/remotecontent?filepath=co/elastic/apm/elastic-apm-agent/1.9.0/elastic-apm-agent-1.9.0.jar
#
